...
const _getActionRouter = () => {
  ...
  const messageConvertHandler = a.action.getHandlerMessageConvert(argNamed({
    core: [a.core.handleMessageConvert, a.core.createResponse],
  }))
  expressRouter.post(`${setting.browserServerSetting.getValue('apiEndpoint')}/message/convert`, messageConvertHandler)
